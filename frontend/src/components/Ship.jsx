  ...
  return (
    ...
    >
      <div className="max-w-[1180px] mx-auto px-7 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          <p className="font-mono text-sm lg:text-xs tracking-[0.16em] uppercase text-ash mb-4 font-bold flex items-center gap-2 before:content-[''] before:w-3.5 before:h-0.5 before:bg-black">
            FROM BRIEF TO PRODUCTION
          </p>
          <h2 className="font-display text-4xl font-extrabold lg:text-[clamp(28px,3.6vw,44px)] tracking-[-0.01em] leading-[1.12] text-paper">
            What you can ship tonight.
          </h2>
          <p className="text-ash text-lg lg:text-sm font-medium my-[18px] mb-[30px] leading-[1.7] max-w-[440px]">
          ...
          <ul>
            {shipList.map((item, i) => (
              ...
              >
                <span className="text-black w-[22px] text-center text-lg lg:text-sm flex-shrink-0">
                  {item.icon}
                </span>
                {item.label}
              </li>
