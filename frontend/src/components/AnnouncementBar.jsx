export default function AnnouncementBar() {
  return (
    <div className="bg-white border-b border-hairline shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
      <div className="max-w-[1180px] mx-auto flex items-center justify-center gap-3.5 flex-wrap px-7 py-2.5 text-center font-mono text-sm md:text-xs text-ash font-semibold">
        <span>
